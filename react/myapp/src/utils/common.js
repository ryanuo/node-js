/*
 * @Author: Harry
 * @Date: 2022-06-29 18:16:47
 * @LastEditors: harry
 * @Github: https://github.com/rr210
 * @LastEditTime: 2022-06-29 19:48:35
 * @FilePath: \node-js\react\myapp\src\utils\common.js
 */
export const mealDatas = [
    {
        id: '1',
        title: '汉堡包',
...
export const cartReducer = function (state, action) {
    ...
    switch (action.type) {
        ...
        case 'CLEAR_CART':
            ...
            return newCart;
        case 'FILTER_CART':
            return newCart.item.filter(item => item.title.indexOf(action.keyword) !== -1);
        default:
            return state;
    }
}